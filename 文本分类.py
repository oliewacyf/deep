import pandas as pd
train = pd.read_table("C:\\Users\\Acer\\Desktop\\train.txt", sep='\t',header=None)  # 训练集
dev = pd.read_table("C:\\Users\\Acer\\Desktop\\dev.txt", sep='\t',header=None)      # 验证集
test = pd.read_table("C:\\Users\\Acer\\Desktop\\test.txt", sep='\t',header=None)    # 测试集
...
# 保存处理后的数据集文件
train.to_csv("C:\\Users\\Acer\\Desktop\\train.csv", sep='\t', index=False)  # 保存训练集，格式为text_a,label
dev.to_csv("C:\\Users\\Acer\\Desktop\\dev.csv", sep='\t', index=False)      # 保存验证集，格式为text_a,label
test.to_csv("C:\\Users\\Acer\\Desktop\\test.csv", sep='\t', index=False)    # 保存测试集，格式为text_a
...
class NewsData(DatasetBuilder):
    SPLITS = {
        'train': "C:\\Users\\Acer\\Desktop\\train.csv",  # 训练集
        'dev': "C:\\Users\\Acer\\Desktop\\dev.csv",      # 验证集
    }
...
# 读取要进行预测的测试集文件
test = pd.read_csv("C:\\Users\\Acer\\Desktop\\dev.csv",sep='\t')
...
write_results(results, "C:\\Users\\Acer\\Desktop\\results.csv")
